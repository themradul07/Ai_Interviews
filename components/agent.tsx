...
const Agent = ({ userName, userId, type, interviewId, questions }: AgentProps) => {
    ...
    const isCallInactiveOrFinshed = callStatus === CallStatus.INACTIVE || callStatus === CallStatus.FINISHED;
    ...
    return (
        <>
            <div className="call-view">
                ...
                <div className="card-border">
                    <div className="card-content">
                        <img src={`https://ui-avatars.com/api/?name=${userName}&background=random&color=fff&size=128`} alt="user avatar" width={540} height={540} className="rounded-full object-cover size-[120px]" />
                        <h3>{userName}</h3>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full flex justify-center">
                {callStatus !== 'ACTIVE' ? (
                    <button className="relative btn-call" onClick={handleCall} disabled={callStatus === 'CONNECTING'}>
